...
0.46). No ranking reversed. The three claims, restated on corrected
...
|---|---|---|---|---|---|
| anchor, 78 V, 1 s, 5 % | 1800 | 17.3 | 21.3 / 46.2 | 63.0 / 18.7 | 91 |
| 60 V, 1 s, 5 % | 1233 | 0.20 | 1.2 / 1.0 | 8.5 / 0.8 | 50 |
| 78 V, 0.2 s, 5 % | 1131 | 0.10 | 0.0 / 0.4 | 1.2 / 0.4 | 87 |
| 78 V, 1 s, 20 % | 3063 | 34.5 | 13.2 / 56.0 | 66.5 / 25.8 | 510 |
...
domain. Between those, the anchor's advantage stands: 21.3 against 46.2
percent benzene at the same 17.3 percent conversion, a ratio of 0.46.

Round 2, smaller steps:

| drive | peak, C | X, % | S_C6H6 pulse / steady, % | S_C2H2 pulse / steady, % | element W |
|---|---|---|---|---|---|
| 70 V, 1 s, 5 % | 1534 | 13.0 | 28.4 / 40.9 | 56.8 / 17.8 | 71 |
| 78 V, 2 s, 5 % | 2595 | 9.7 | 15.5 / 36.9 | 67.5 / 17.2 | 101 |
| 78 V, 1 s, 10 % | 2707 | 26.8 | 15.0 / 57.9 | 67.6 / 20.5 | 213 |
| 70 V, 1 s, 10 % | 2340 | 24.8 | 16.1 / 55.4 | 67.3 / 20.1 | 160 |

Only the 70 V row stays inside the element's domain, and it is worse than
the anchor: benzene at 0.69 of the steady value against the anchor's 0.46.
Every row that overshoots the peak protects more (0.24 to 0.42), so the
...
|---|---|---|---|---|---|
| 78 V, 1 s, 5 % (anchor) | 502 / 887 | 17.3 | 21.3 / 46.2 | 63.0 / 18.7 | 91 |
| 57.7 V, 1 s, 10 % | 523 / 924 | 19.1 | 20.3 / 48.5 | 63.9 / 19.0 | 100 |
| 44.8 V, 1 s, 20 % | 570 / 1006 | 23.6 | 18.4 / 54.0 | 65.6 / 19.9 | 123 |
| 97.1 V, 0.5 s, 5 % | 780 / 1128 | 37.6 | 21.1 / 53.7 | 63.2 / 28.4 | 144 |
| 61.4 V, 2 s, 5 % | 235 / 635 | 7.1 | 20.6 / 33.7 | 63.7 / 16.7 | 55 |
| 122.5 V, 0.2 s, 5 % | 1135 / 1401 | 74.0 | 15.9 / 25.6 | 68.3 / 59.5 | 238 |
...
hot part of the cycle. Everything that changes in the ratio column (0.34
to 0.61) comes from the steady comparator, which needs a different
