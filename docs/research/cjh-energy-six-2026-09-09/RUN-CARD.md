...
## Authorized completion after the first cap

The user requested continuation after seeing the two completed points. Complete the remaining CH4 0.65 / 400 sccm and CH4 0.8 / 100, 200, 400 sccm conditions in one further 300-second, single-thread batch. Verify all previous source hashes and reuse the passed anchor and paired gates. Preserve the original timeout record and store a separate resume manifest/status. Stop on any failed numerical gate or the time cap. No additional design conditions or BO acquisitions are included.
